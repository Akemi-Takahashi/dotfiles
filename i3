...
bindsym $mod+r exec --no-startup-id rofi -show run -lines 3 -eh 2 -width 100 -padding 400 -bw 0 -font "Fira Sans 20" -hide-scrollbar
...
#Autostart
exec_always --no-startup-id feh --bg-fill ~/Pictures/Clips.jpeg
exec_always --no-startup-id compton -b -r 0 -o 0.0 -C -z -f -G

#Custom workspace opener
